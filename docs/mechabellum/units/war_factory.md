...
The War Factory is one of the strongest units in Mechabellum and has the highest stats on paper. This Titan Mobile Factory is an expensive and colossal unit that boasts immense durability and firepower.

The War Factory's main weapon is housed in four turrets along its hull that can independently engage different targets, potentially quadrupling its stated damage output. However, its turrets have limited arcs of fire - rear turrets cannot engage foes in front, and front turrets cannot engage foes behind.

**Important:** The War Factory is the only unit that incurs upkeep - 200 supplies are automatically deducted from your income at the start of each round for every War Factory you have on the field.
...
- Beacon at angle across enemy board for better turret coverage
...
### What Beats War Factory

| Unit | Effectiveness | Notes |
|------|---------------|-------|
| **Scorpion (Acid)** | Hard Counter | Acid Attack + Range melts the factory |
| **Melting Point** | Hard Counter | Beam destroys even War Factory |
| **Crawler (Acid)** | Good Counter | 8 Acid Crawlers can defeat 1 War Factory |
| **Marksman** | Good Counter | Long-range single-target damage |
| **Phoenix** | Good Counter | Air unit, factory cannot target |

### What War Factory Beats

| Unit | Effectiveness | Notes |
|------|---------------|-------|
| **Sandworm** | Hard Counter | Absolutely demolishes Sandworms |
| **Ground Giants** | Strong Counter | Massive HP and damage output |
| **Melee Units** | Strong Counter | Production line creates endless defenders |
| **Fortress** | Good Counter | Can out-trade with production support |
| **Ground Army** | Good Counter | Missile Intercept protects entire flank |

## Strategy Tips

### Offensive Use

1. **Aggressive Push** - Bring immense stats to frontline with Steel Ball Production for tower pressure and additional chaff.

2. **Missile Intercept** - Protects aggressive strategies from Stormcallers, Farseers, and Phantom Rays.

3. **Early Game Warning** - Do NOT buy War Factory before turn 5 unless you can immediately buy Efficient Maintenance.

### Defensive Use

1. **Flank Protection** - Position behind tower to protect flanks with Sledgehammer and Phoenix Production.

2. **Missile Defense** - Use Missile Intercept to protect your army from missile-based attacks.

3. **Production Factory** - Focus on Sledgehammer + Phoenix Production to churn out endless units.

### Tech Build Paths

**Standard Build:**
1. Efficient Maintenance (FIRST - reduce upkeep)
2. Sledgehammer Production
3. Phoenix Production (anti-air coverage)

**Aggressive Push:**
1. Efficient Maintenance
2. Steel Ball Production
3. Missile Intercept (protect the push)
4. Launcher Overload
...
4. Range Enhancement (stay safe)

**Anti-Scorpion Build:**
1. Efficient Maintenance
2. Range Enhancement
3. Photon Coating (anti-acid)

### Production Strategy

Two main strategies:

1. **Aggressive Factory** - Bring stats to frontline with Steel Ball Production. Missile Intercept protects other components of the strategy.

2. **Production Factory** - Position behind tower to protect flanks. Use Sledgehammer and Phoenix Production to churn out units continuously.

## Synergies

| Unit | Synergy | Notes |
|------|---------|-------|
| **Sledgehammer (Production)** | Excellent | Self-synergy with production tech |
| **Steel Ball (Production)** | Excellent | Self-synergy with production tech |
| **Phoenix (Production)** | Excellent | Self-synergy, provides anti-air |
| **Chaff Clear** | Good | Protect factory from Crawlers |
| **Anti-Air** | Good | Factory cannot target air |
